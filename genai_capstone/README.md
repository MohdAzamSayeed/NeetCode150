...
Project Description
This project aims to build an AI agent–based knowledge and decision support system. The
application allows users to upload documents in multiple formats (PDF, TXT, CSV, Excel) and
ask natural language questions. The system retrieves relevant content using a vector database
